...
# 在脚本顶部定义风格选项
STYLE_OPTIONS = {
    "二次元风格": "动漫风格，色彩鲜艳，线条流畅，具有卡通特点。",
    "写实风格": "真实风格，细节丰富，色彩自然，具有现实感。",
    "抽象风格": "抽象风格，形状和颜色夸张，具有艺术感。"
}

# 在 Streamlit 应用中添加风格选择框
selected_style = st.sidebar.selectbox("选择图片风格", list(STYLE_OPTIONS.keys()), index=0)
...
def draw_new_image():
    ...
    image_prompt = f'{style_description} {image_prompt.strip()}'
